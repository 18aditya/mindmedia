            ...
            <div className="w-[40%] sm:w-[25%] flex flex-col items-center">
                ...
                <div className="mt-[15px]">
                    <a
                        ...
                        target="_blank"
                        className="bg-primary-500 text-white text-[.7rem] sm:text-[.7rem] lg:text-[.8rem] xl:text-[.9rem] px-[25px] py-[10px] rounded-full uppercase transition duration-300 ease-in-out inline-block mt-[20px] transform hover:bg-primary hover:shadow-[0px_0px_52px_18px_rgba(0,_0,_0,_0.1)] hover:-translate-y-1"
                    >
                        View All
                    </a>
                </div>
