                        ...
                        <div className="w-full h-[573px] justify-center overflow-hidden relative">
                            ...
                            <div className="relative sm:absolute bottom-0 left-0 w-full py-[30px] sm:px-[50px] font-primary font-light sm:bg-gradient-bottom md:h-[90%] lg:h-[50%] sm:flex flex-col justify-end">
                                ...
                                <div className="mt-[15px]">
                                    <a
                                        href={facility.link}
                                        className="bg-primary-500 text-white text-[.7rem] sm:text-[.7rem] px-[25px] py-[10px] rounded-full uppercase transition duration-300 ease-in-out inline-block mt-[20px] transform hover:bg-[#A26928] hover:shadow-[0px_0px_52px_18px_rgba(0,_0,_0,_0.1)] hover:-translate-y-1"
                                    >
                                        Explore
                                    </a>
                                </div>
